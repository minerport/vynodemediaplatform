...
OWNER and ADMIN users can create, edit, and delete validated manual markers. Changes are security-audited. Phase 8 adds automatic candidates with explicit provenance, confidence, review state, source identity, rejection suppression, and strict manual precedence. See `AUTOMATIC_MARKERS.md`.
